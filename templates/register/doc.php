...
<head>
    ...
    <meta name="description" content="Mental Space - Doctor Registration">
    <meta name="keywords" content="mental,space,ptsd,bipolar,mood,disorder">
    <meta name="author" content="Moebius Integrated Systems">
    <title>Register Page - Mental Space</title>
                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            ...
                            <form class="auth-register-form mt-2" action="/register_doc" method="POST" id="register_form">
                                ...
                                <div class="mb-1">
                                    <label for="email" class="form-label"><?php echo __("E-Mail"); ?></label>
                                ...
                                <button class="btn btn-primary w-100" tabindex="5"><?php echo __("Registrami"); ?></button>
                            </form>
...
<script>
    ...
    $( "#register_form" ).submit(function( event ) {
        ...
        if($("#register-privacy-policy").prop("checked")){
            $.post("/register_doc", $("#register_form").serialize(), function(data){
