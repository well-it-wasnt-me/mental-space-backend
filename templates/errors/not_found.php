...
<head>
    ...
    <link rel="apple-touch-icon" href="http://localhost:8080/app-assets/images/mental-space-logo/png/logo-no-background.png">
    <link rel="shortcut icon" type="image/x-icon" href="http://localhost:8080/app-assets/images/mental-space-logo/png/logo-no-background.png">
