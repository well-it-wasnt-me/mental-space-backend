                    ...
                    <div class="col-xl-4 col-lg-5 col-md-5 order-1 order-md-0">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="user-avatar-section">
                                    <div class="d-flex align-items-center flex-column">
                                        ...
                                        <div class="user-info text-center">
                                            <h4>Name and Surname are Hidden</h4>
                                            <span class="badge bg-light-secondary"><?php echo __("Privacy mode ON"); ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-around my-2 pt-75">
                                    <div class="d-flex align-items-start me-2">
                                        ...
                                        <div class="ms-75">
                                            ...
                                            <small><?php echo __("Steps made today");?></small>
                                        </div>
                                    </div>
                                ...
                                <h4 class="fw-bolder border-bottom pb-50 mb-1"><?php echo __("Details");?></h4>
                                <div class="info-container">
                                    <ul class="list-unstyled">
                                        ...
                                        <li class="mb-75">
                                            ...
                                            <span><?php echo $patient['icd_ten'] . " <span id='desc_dsm'>" . $patient['description'] . "</span>"; ?></span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
                        ...
                        <ul class="nav nav-pills mb-2">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#annotazioni" data-bs-toggle="pill" aria-expanded="false">
                                    <i data-feather="file-plus" class="font-medium-3 me-50"></i><span class="fw-bold"><?php echo __("Annotations"); ?></span>
                                </a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="home" aria-labelledby="home-tab" aria-expanded="true">
                                <div class="card">
                                    <h4 class="card-header"><?php echo __("Drugs Treatment"); ?></h4>
                                ...
                                <!-- Activity Timeline -->
                                <div class="card">
                                    <h4 class="card-header"><?php echo __("Last 10 Mood tracked"); ?></h4>
                            ...
                            <div class="tab-pane" id="diario_paziente" role="tabpanel" aria-labelledby="security" aria-expanded="false">
                                <div class="card">
                                    <div class="card-header border-bottom">
                                        <h4 class="card-title"><?php echo __("His Diary"); ?></h4>
                                    </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body pt-1">
                                                <?php
                                                    ...
                                                    echo "<h3>". __("BEHAVIOUR")."</h3>";
                                                    echo $stats['comportamento'];

                                                    echo "<h3>". __("EMOTIONS") ."</h3>";
                                                    echo $stats['emozioni_stat'];

                                                    echo "<h3>" . __("EMOTION AVERAGE") . "</h3>";
                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body pt-1">
                                                ...
                                                <?php echo $phq;?>
                                                <br>
                                                <h3><?php echo __("Impulsive Behaviour"); ?></h3>
                                                <?php echo $compImp; ?>
                                                <br>
                ...
                <div class="modal-content">
                    <div class="modal-body pb-5 px-sm-5 pt-50">
                        <div class="text-center mb-2">
                            <h1 class="mb-1"><?php echo __("Patient Folder Access"); ?></h1>
                            <p><?php echo __("Please, enter the code you received via e-mail"); ?></p>
                        </div>
                        <form id="consultoForm" class="row gy-1 pt-75" onsubmit="return false">
                            <div class="row">
                                <div class="col-12 col-md-12">
                                    <label class="form-label" for="modalEditUserFirstName"><?php echo __("PIN Code");?></label>
